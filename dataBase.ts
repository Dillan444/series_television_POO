...
const serie1Ep1 = new Episodio(
  "La desaparición de Will Byers", 
  "Will Byers desaparece misteriosamente cuando vuelve a casa tras jugar diez largas horas con sus mejores amigos, mientras tanto una niña con asombrosas cualidades aparece en una cafetería de la localidad.", 
  45
)

const serie1Ep2 = new Episodio(
  "La loca de la calle Maple",
  "Los chicos se topan con la niña, ella le enseña un tatuaje a Mike con el número 11, indicándole que ese es su nombre. Once reconoce a Will en una foto por lo que los chicos suponen que sabe cual es el paradero de su amigo.",
  45
)

const serie1Ep3 = new Episodio(
  "Todo está bien",
  "Nancy, cada vez más preocupada, busca a su mejor amiga Barb y descubre lo que Jonathan está tramando. Joyce está segura de que Will está comunicándose con ella mediante las luces de su casa.",
  44
)
...
const serie2Ep1 = new Episodio(
  "Crueldad",
  "Tanjiro es un joven muy trabajador que se esfuerza mucho por cuidar de su madre y sus hermanos",
  44
)

const serie2Ep2 = new Episodio(
  "El instructor, Sakonji Urokodaki",
  "Tanjiro y Nezuko continúan su viaje para volver a Nezuko nuevamente humana, al llegar a un santuario, Tanjiro lucha contra un demonio que comía los restos de un cadáver",
  25
)

const serie2Ep3 = new Episodio(
  "Sabito y Makomo",
  "Tanjiro sigue el duro entrenamiento que le había dejado Sakonji",
  24
)
